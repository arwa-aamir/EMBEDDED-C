...
// Use ESP8266 Smart Config App from playstore to allocate ip to ESP32 by your mobile,

// Use Wifi SSID and Pwd, which will assign IP to ESP 32

// No need to define Password and SSID within your code.
